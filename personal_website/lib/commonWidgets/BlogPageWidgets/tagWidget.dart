...
class TagWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<Color> red = [Color.fromARGB(255, 255, 216, 216), Colors.red];
    List<Color> green = [
      Color.fromARGB(255, 206, 253, 210),
      Color.fromARGB(255, 49, 136, 52)
    ];
    List<Color> blue = [Color.fromARGB(31, 144, 220, 244), Colors.blue];

    List<List<Color>> allColors = [red, green, blue];
